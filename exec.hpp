		...
		while(adminLoop)
		{
			...
			if(stringChoice == "1")
			{
				...
				if (initialTime != 2330)
				{
					if(hoursChoiceBool)
					{
						std::cout << "At what time will your event end? (If there are breaks in the event, input the end time before a break). If you want your event to go until 23:59 enter 2359 \n";
